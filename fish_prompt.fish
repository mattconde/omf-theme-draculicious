...
set -g fish_color_search_match purple # the color used to highlight history search matches
set -g fish_color_selection purple
...
set -g fish_color_autosuggestion brgrey # the color used for autosuggestions
